...
function addPayment($data) {
	...
	if (is_array($data)) {
		    ...
		    $trnstype='desposite';
	        $razorpayOrderId =	$data['txn_id'];
			$newcoins = $data['payment_amount'];
		...
		$insertquery =mysqli_query($conn,"update users set status='".$status."', trnsid='".$razorpayOrderId."' WHERE orderid='".$orderid."'");
		$insertquery;
