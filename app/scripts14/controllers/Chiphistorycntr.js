...
e.raiseevent=function(i){var i;e.hstshow=!0,e.legershow=!1,t.get("Betentrycntr/Chip_history/"+i.data.UserID+"/"+e.type+"/"+i.data.MatchId+"/"+i.data.MarketId+"/"+i.data.oppAcID).success(function(t,i,a,r){
...
var p;
e.getChipHistoryData=function(i,a,r,l){t.get("Betentrycntr/Chip_history/"+e.loginId+"/"+from+"/"+to+"/"+type+"/"+e.type).success(function(t,i,a,r){e.chip_data=t.chips_data,e.gridOptions.api.setRowData(e.chip_data),s(t.chips_data,""),e.SumOfCreadit=e.sum(e.chip_data,"Credit"),
...
var o="",h="";else if(a!=angular.isUndefinedOrNull&&r!=angular.isUndefinedOrNull)var o=i("date")(a,"yyyy-MM-dd"),h=i("date")(r,"yyyy-MM-dd");
    if(o == "1970-01-01" || o==0){
        o ='';}
    else{
       // a = t('date')(e.from_date, 'yyyy-MM-dd');
    }
    if(h == "1970-01-01" || h==0){
        h ='';}
    else
