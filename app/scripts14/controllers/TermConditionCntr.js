app.controller('TermConditionCntr',['$scope','$http', 'sessionService', '$timeout', '$filter','$stateParams','Dialog','Base64', function ($scope,$http, sessionService, $timeout,$filter,$stateParams,Dialog,Base64) {
