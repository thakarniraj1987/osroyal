...
var MatchId = getUrlParam("MatchId")
	...
	// alert(MatchId);	 
    if (dvPlayerN != null) {
        iframe = '<iframe id="fp_embed_player" src="https://videoplayer.betfair.com/GetPlayer.do?tr=1&eID='+MatchId+'&allowPopup=true&contentType=viz&statsToggle=hide&contentOnly=true" marginwidth="0" marginheight="0" frameborder="0" width="100%" height="275" scrolling="no" allowfullscreen="allowfullscreen"></iframe>';
