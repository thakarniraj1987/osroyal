'use strict';
angular.module('ApsilonApp').directive('headerNotificationdealer', ['$timeout', function ($timeout) {
    return {
        templateUrl: 'app/scripts/directives/header/header-notification/header-notification_dealer.html?var='+Math.random(),
        restrict: 'E',
        replace: true,
        scope: {},
