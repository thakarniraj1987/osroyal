app.controller("Seriescontroller",["$scope","$http","$timeout","$log","$mdDialog","Dialog",function(e,t,a,i,n,Dialog){e.loading=!0,e.GetSeriesData=function(a){t.get("Geteventcntr/getSeriesLst/"+a).success(function(t,a,i,n){e.match_data=t.seriesLst,e.currentPage=1,e.entryLimit=20,e.maxSize=5;e.filteredItems=e.match_data.length,e.totalItems=e.match_data.length,e.loading=!1}).error(function(t,a,i,n){e.ResponseDetails="Data: "+t+"<br />status: "+a+"<br />headers: "+jsonFilter(i)+"<br />config: "+jsonFilter(n)})},e.GetSeriesData(0),e.changeMatchStatus=function(a,i){if(1==i)var n=1;else var n=0;if(e.loading=!0,1==n)var s=confirm("Are you sure want to Activate this Series ?");else var s=confirm("Are you sure want to Deactivate this Series ?");s?t.get("Lstsavemstrcontroller/updateSeriesSatatus/"+a+"/"+n+"/").success(function(t,a,i,n){
...
t.get('Geteventcntr/GetSportFrmDatabase').success(function (data, status, headers, config) {
