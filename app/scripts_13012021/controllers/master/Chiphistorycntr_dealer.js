app.controller('Chiphistorycntr', function ($scope, $http, $filter, sessionService, loginService, $rootScope, $location,$stateParams) {
    ...
    $scope.raiseevent = function (params) {        
        ...
        $http.get('Betentrycntr/Chip_history/' + params.data.UserID + '/' + ssessionService.get('type') + '/' + params.data.MatchId + '/' + params.data.MarketId + '/' + params.data.oppAcID).success(function (data, status, headers, config) {
    ...
    $scope.getChipHistoryData = function (from_date, to_date, slctType, withParent) {
        ...
        $http.get('Betentrycntr/Chip_history/' + $stateParams.UserID + '/' + from + '/' + to + '/' + type + '/' + $stateParams.usetype).success(function (data, status, headers, config) {
            $scope.chip_data = data.chips_data;
            setRowData(data.chips_data, '');
    ...
    $scope.ChipLeger = function (from_date, to_date, slctType, withParent) {
        ...
        $http.get('Betentrycntr/Chip_leger/' + $stateParams.UserID + '/' + $stateParams.usetype + '/' + drpdwn + '/' + fromDate + '/' + toDate).success(function (data, status, headers, config) {
