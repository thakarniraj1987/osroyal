'use strict';
angular.module('ApsilonApp').controller('ClientListcntr',['$scope','$mdDialog', '$http', 'sessionService', '$timeout', 'deviceDetector','$filter','$rootScope','$window', function ($scope, $mdDialog,$http, sessionService, $timeout, deviceDetector,$filter,$rootScope,$window) {
...
$scope.GetUserList();
    ...
    $scope.UpdateViewAccount = function (useinfo, node) {
                ...
                var mstrRemarks = useinfo.mstrRemarks;
                var accountUserData = {
                        userId: userId,
                        name: Name,
    ...
    function showViewSettingController($scope, $mdDialog, prntScope, node, Dialog,get_userser,sessionService) {
        ...
        $scope.UpdateViewAccount = function (user, node) {
                ...
                var mstrRemarks =  document.getElementById('mstrRemarks1').value;
