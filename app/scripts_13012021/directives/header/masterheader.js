...
app.directive('masterheader', ['$location','$http', 'sessionService', '$timeout','$interval','get_userser','$state','speech', function ($window, $http, sessionService, $timeout,$interval,get_userser,$state,speech) {
    return {
        templateUrl: 'directives/masterheader',
        restrict: 'E',
        replace: true,
        scope: {},
...
$scope.FreeChipsSubmit = function (Chip, Type, UserID, Free, userType) {
		//
			...
			$rootScope.$broadcast("callrefreshTree",{});
