...
define('BR_LIVE_SESSION_URL','http://18.130.213.12/betfair/betting_apis/market.php?market_id=');
define('BR_LIVE_ODDS_URL','http://18.130.213.12/betfair/betting_apis/odds.php?');
define('BR_LIVE_SERIES_URL','http://18.130.213.12/betfair/betting_apis/series.php?series_id=');
define('BR_LIVE_MATCHES_URL','http://18.130.213.12/betfair/betting_apis/matches.php?');
define('BR_LIVE_RESULT_URL','http://18.130.213.12/betfair/betting_apis/result.php?');
define('BR_LIVE_MATCHES_ODDS_URL','http://18.130.213.12/betfair/betting_apis/multi_market.php?');
...
define('BR_LIVE_SESSION_SOCKET_URL','http://139.162.242.237/session_data.php');