...
defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class Modellstmaster extends CI_Model{
		...
		function getFancylistHeader(){
			...
			$this->db->select("mf.ID,mf.Remarks,mchmst.matchName,mf.HeadName,mf.active,mf.result,mf.TypeID,mchmst.SportID as SportID,mf.MatchID,mf.is_indian_fancy,mf.fancy_mode,market.Id market_id,mf.ind_fancy_selection_id mFancyId");
