...
//		        $remarks .= $_POST['partnership'];
	...
	{
		$this->db->select('mstruserid,usetype,mstrlock,lgnusrlckbtng,lgnusrCloseAc,IFNULL(lgnUserMaxStake,"0") as stakeLimit,lgnUserMaxProfit,lgnUserMaxLoss,IFNULL(InPlayStack,"0") as GoingInplayStakeLimit,set_timeout,match_stake,one_click_stake');
		$this->db->from('createmaster');
