...
defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class Apimastercontroller extends CI_Controller {
		var $globalUserId;
		var $globalUserType;
		...
		function get_matches(){	
			...
			$response["data"] = $this->Modeleventlst->getMasterMatchLst($userId);
			$this->output->set_status_header(200)->set_content_type('application/json')->set_output(json_encode($response));
		...
		function get_match_session($matchId=NULL){	
			...
			$response["data"] = $this->Modellstmaster->getMasterFancylist($userId,$matchId);
			$this->output->set_status_header(200)->set_content_type('application/json')->set_output(json_encode($response));
		}
