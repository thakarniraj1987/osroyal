...
<button  onclick="myfunright()" class="navbar-toggler navbar-toggler-right" type="button">
   ...
   <!--<nav class="navbar navbar-static-top">
        <div class="container-fluid">
           <div class="padding" id="navbarResponsive">
...
<div class="account-overview">
 ...
 <div class="othermenu">
   ...
   <a class="dropdown-item" href="#" ui-sref-active="active" ui-sref="masterDashboard.changePasswordUser">Change Password</a>
            <a class="dropdown-item"  ui-sref-active="active" href="#" ui-sref="masterDashboard.OnePageRprt({typeId:1})">Bet History</a>
            <a class="dropdown-item" ui-sref-active="active" href="#" ui-sref="masterDashboard.Profitlosscntr">Profit & Loss</a>
            <a class="dropdown-item " href="#" ui-sref="masterDashboard.ShowTermCondition">Term & Condition</a>
...
<aside class="main-sidebar" style="top:50px">
 ...
 <input id="tab1" class="tab-inp" type="radio" name="tabs"  ng-model="treeAcc" ng-value="false" ng-checked="!treeAcc"></input>
   ...
   <ul class="sidebar-menu">
         <li ui-sref-active="active" class="active treeview" onclick="myfun()"><a ui-sref="masterDashboard.Home"><i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>
<li  ui-sref-active="active" onclick="myfun()"><a ui-sref="masterDashboard.OnePageRprt({typeId:1})"><i style="float: left;position: relative;" class="fa fa-file" aria-hidden="true"></i>  One Page Report</a> </li>
<li ng-if="false" ui-sref-active="active" onclick="myfun()"><a ui-sref="masterDashboard.CollectionReport"><i style="float: left;position: relative;" class="fa fa-file" aria-hidden="true"></i>  Collection Report</a> </li>
         <li ui-sref-active="active" onclick="myfun()"><a ui-sref="masterDashboard.ClientList"><i class="fa fa-list" aria-hidden="true"></i><span>DealerList</span></a></li>
       <li ui-sref-active="active" onclick="myfun()"><a ui-sref="masterDashboard.Chiphistorycntr"><i class="fa fa-history" aria-hidden="true"></i><span>Chip History</span></a></li>
         <li ui-sref-active="active" onclick="myfun()"><a ui-sref="masterDashboard.ChipSummaryCntr"><i class="fa fa-microchip"></i><span>Chips Summary</span></a></li>
 <li ui-sref-active="active" onclick="myfun()"><a ui-sref="masterDashboard.Createfancy"><i class="fa fa-cog"></i><span>Match Setting</span></a></li>
       </ul>
<!-- <div class="container-fluid"> -->
        <!-- Brand and toggle get grouped for better mobile display -->
        <!--<div class="navbar-header">
          <button type="button" class="navbarnavbar-custom-menu-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse-1">
      ...
      <section id="content2" class="tab-content clearfix" ng-show="treeAcc==1">
        <div class="col-sm-12 col-md-12">
          ...
          <ul>
            ...
            <li ng-hide="node.usetype == 0 || node.usetype==1"> <a ng-show="$root.HelperAllRights==angular.isUndefinedOrNull || $root.HelperAllRights.UpdateUser==1" href="" ng-click="showViewSetting(node,currentScope1);">View Acc.</a> </li>
            <li ng-hide="node.usetype==1"> <a ng-show="$root.HelperAllRights==angular.isUndefinedOrNull || $root.HelperAllRights.ChangePwd==1" href="" ng-click="showChangePwd(node,currentScope1);">Change Pwd.</a> </li>
                     <hr ng-show="sessionuser_id!=node.id || node.usetype==0"/>
            <li ng-show="node.usetype!=1"> <a href="" ng-click="showFreeChips(node,currentScope1);">A/c Chips In/Out</a> </li>
            <!--  <li ng-show="sessionuser_id!=node.id || node.usetype==0">
                <a href="" ng-click="showSettlement(node,currentScope1);">Settlement</a>
              </li> -->
            <hr ng-show="sessionuser_id!=node.id && node.usetype!=1"/>
                    <li ng-show="sessionuser_id!=node.id && (!(node.lgnusrCloseAc==0 && sessionusetype!=3)) && ($root.HelperAllRights==angular.isUndefinedOrNull || $root.HelperAllRights.BettingLock==1) && node.usetype!=1"> <a href="" ng-click="showLockBetting(node)" ng-if="node.lgnusrlckbtng==0 && sessionusetype!=3?lckbting='Unlock Betting':lckbting='Lock Betting'">{{lckbting}}</a> </li>
          </ul>
          </span> </div>
      </section>
</div>
