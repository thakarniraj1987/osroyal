...
<a class="navbar-brand js-scroll-trigger" ui-sref="masterDashboard.Home"><img src="app/images/logo.png"><!--<img ng-if="false" src="{{$root.logo}}" alt="Logo">Demo_New--></a>
   ...
   <div class="status-icon new_topdowm" ng-if="usertype == 0 && false">
                <span>
...
<div class="account-overview">
    <p class="login-name">{{$root.user}}</p>
        ...
        <div class="menu-item" ng-if="subAdmin=='false' || subAdmin=='undefined'">
            <p class="label">
 ...
 <div class="othermenu">
  ...
  <md-menu md-position-mode="target-right target" md-offset="0 58">
                    ...
                    <md-button onClick="addClass(this)" ng-if="IsShowMenu('AccountStatements')"  ui-sref="dashboard.OnePageRprt({typeId:3})"><span class="drp-txt">Account Statement</span></md-button>
                    <md-button ng-if="IsShowMenu('MarketWatch')" onClick="addClass(this)" ui-sref="dashboard.Home"><span class="drp-txt">My Market</span></md-button>
                    <md-button ng-if="IsShowMenu('profitAndLoss')" onClick="addClass(this)"  ui-sref="dashboard.Profitlosscntr"><span class="drp-txt">Profit & Loss</span></md-button>
                    <md-button onClick="addClass(this)" ui-sref="dashboard.changePasswordUser"><span class="drp-txt">Change Pwd</span></md-button>
                    <md-button ng-if="IsShowMenu('OnlineUsers')" onClick="addClass(this)" ui-sref="dashboard.Onlineusersctrl"><span class="drp-txt">Online Users</span></md-button>
                    <md-button ng-if="IsShowMenu('BetHistory') && IsShowMenu('onePageReportSetting')" onClick="addClass(this)"  ui-sref="dashboard.OnePageRprt({typeId:1})"><span class="drp-txt">Bet History</span></md-button>
													                           
                    <md-button ng-if="IsShowMenu('user')" onClick="addClass(this)" ui-sref="dashboard.Userlist"><span class="drp-txt">User List</span></md-button>
                    <md-button ng-if="IsShowMenu('user')" onClick="addClass(this)" ui-sref="dashboard.Get_actMtchUsersCntr"><span class="drp-txt">Active Users</span></md-button>
                    <span ng-show="$root.HelperAllRights==angular.isUndefinedOrNull || $root.HelperAllRights.ChipHistory==1">
                    <md-button ng-if="IsShowMenu('ChipHistory') && false" onClick="addClass(this)" ui-sref="dashboard.Chiphistorycntr"><span class="drp-txt">Balance History</span></md-button>
