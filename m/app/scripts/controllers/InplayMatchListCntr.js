'use strict';
angular.module('ApsilonApp').controller('InplayMatchListCntr',['$scope', '$http', 'sessionService', '$timeout', 'deviceDetector','$filter', function ($scope, $http, sessionService, $timeout, deviceDetector,$filter) {
