angular.module('ApsilonApp').controller('myMarketCntr', function ($scope, $http, sessionService, $timeout, $filter) {
    ...
    //    $scope.GetMarketBackLayDataSelectionName = null;
        //$http.get( BASE_URL+'Geteventcntr/getBackLaysOfMarketSelectionName/' + $scope.MarketId + '/' + $scope.logInId + '/' + $scope.logInTypeId + '/' + $scope.MatchId).success(function (data, status, headers, config)
        //{
