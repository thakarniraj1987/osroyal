...
//}
    ...
    t.loading=true;
    var l={Sport_id:n,Match_id:c,market_id:a,selectionId:r,isFancy:1,sportName:u,matchName:o,MarketName:d,selectionName:i};e({method:"POST",url:BASE_URL+"Geteventcntr/SetResult/",data:l,headers:{"Content-Type":"application/x-www-form-urlencoded"}}).success(function(e){
        t.loading=false;
