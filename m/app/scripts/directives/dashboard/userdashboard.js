...
angular.module('ApsilonApp').controller('userdashboard',['$scope', '$http', 'sessionService', '$timeout', 'deviceDetector','$filter','$rootScope','$location', function ($scope, $http, sessionService, $timeout, deviceDetector,$filter,$rootScope,$location) {
 ...
 $scope.goTomarketPage = function(series){
		alert(series);
