...
app.config(['$stateProvider', '$urlRouterProvider', '$ocLazyLoadProvider','$locationProvider', function ($stateProvider, $urlRouterProvider, $ocLazyLoadProvider,$locationProvider) {
    ...
    $stateProvider
        ...
        .state('userDashboard.Menu', {
            url: '/Menu',
            controller: 'menuctrl',
            templateUrl: 'app/views/pages/user/Menu.html',
            params:      {'SportType': null,'SeriesId':null},
            resolve: {
                loadMyFiles: function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        files: [
                            ...
                            'app/scripts/controllers/MenuCntr.js?ver='+Math.random(),
                        ]
                    })
                }
            }
        ...
        .state('masterDashboard.ShowTermCondition', {
        ...
        .state('dealerDashboard.ShowTermCondition', {
            templateUrl: 'app/views/pages/Term&Condition.html?ver='+Math.random(),
            controller: 'TermConditionCntr',
            url: '/TermAndCondition',
            resolve: {
        ...
        .state('userDashboard.ShowTermCondition', {
            templateUrl: 'app/views/pages/Term&Condition.html?ver='+Math.random(),
            controller: 'TermConditionCntr',
            url: '/TermAndCondition',
            resolve: {
...
app.run(function ($rootScope, sessionService,$location,$state,$templateCache,$http,$q) {
    ...
    $rootScope.$on("$stateChangeStart", function (evt, toState, toParams, fromState, fromParams) {
        ...
        if (window.location.protocol == 'http:') {
            $rootScope.GApiPath="http://libra99.com/Apicontroller/";
        }
        else {
            $rootScope.GApiPath="http://libra99.com/Apicontroller/";
        }
