app.controller('TrashBetCtr',['$scope', '$http', 'sessionService', '$location','$state','Dialog','$filter','$stateParams','Base64', function ($scope, $http, sessionService, $location,$state,Dialog,$filter,$stateParams,Base64) {
