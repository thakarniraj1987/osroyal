...
//alert(e.Marketdata);
e.GetPnL=function(){t.get(BASE_URL+"Betentrycntr/BetHistoryPL/"+e.Marketdata.UserId+"/"+e.Marketdata.matchId+"/"+e.Marketdata.MarketId+"/"+e.Marketdata.fancyId).success(function(t,a,r,s){e.loading=false;e.BetHistory=t.getBetPl,y.api.setRowData(e.BetHistory),o(t.getBetPl),e.SumOfP_L=e.sum(e.BetHistory,"P_L"),e.SumOfProfit=e.sum(
...
t.get(BASE_URL+"Betentrycntr/GetPlus_Minus_Ac/"+a+"/"+s+"/"+i+"/"+l).success(function(t,a,r,s){e.getPlusAc=t.getPlusAc,
