...
$scope.loading=true;
    $http.get( BASE_URL+'Lstsavemstrcontroller/').success(function (data, status, headers, config) {
	...
	var id=user.usecode;
        ...
        if (result) {  $http.get( BASE_URL+'Lstsavemstrcontroller/updateMstr/' + id + '/' + newStatus ).success(function (data, status, headers, config) { 
    ...
    $scope.changeStakeLimit = function (limit, usecode) {
        ...
        $http.get( BASE_URL+'Lstsavemstrcontroller/updateStakeLimit/' + limit + '/' + usecode + '/')
            .success(function (data, status, headers, config) {
                var s = 0;
                $http.get( BASE_URL+'Lstsavemstrcontroller/')
                    .success(function (data, status, headers, config) {
                        $scope.users = data;
                        $scope.currentPage = 1;
                        $scope.entryLimit = 20;
