...
e.setDateFun=function(type)
{
    ...
    var h = [{
        ...
        c = [{
            ...
            field: "Credit",
            width: 130,
cellStyle:function (params) { return (params.data.Credit>=0 ? {color: 'green !important',"text-align":"right"} : {color: 'red !important',"text-align":"right"});}
        }, {
            headerName: "Debit",
            field: "Debit",
            width: 150,
cellStyle:function (params) { return (params.data.Debit>=0 ? {color: 'green !important',"text-align":"right","margin-right":"10px","padding-right": "15px"} : {color: 'red !important',"text-align":"right","margin-right":"10px","padding-right": "15px"});}
        }, {
            headerName: "Balance",
            field: "Balance",
            width: 150,
cellStyle:function (params) { return (params.data.Balance>=0 ? {color: 'green !important',"text-align":"right","margin-right":"10px","padding-right": "15px"} : {color: 'red !important',"text-align":"right","margin-right":"10px","padding-right": "15px"});}
        }, {
            headerName: "id",
            width:80,
            field: "Mstcode",
    ...
    e.raiseevent = function(i) {
       e.loading=true;
        var i;
        e.hstshow = !0, e.legershow = !1, t.get(BASE_URL+"Betentrycntr/Chip_history/" + i.data.UserID + "/" +e.type + "/" + i.data.MatchId + "/" + i.data.MarketId + "/" + i.data.oppAcID).success(function(t, i, a, r) {
         e.loading=false;
    ...
    e.getChipHistoryData = function(i, a, r, l) {
        t.get(BASE_URL+"Betentrycntr/Chip_history/" + e.loginId + "/" + from + "/" + to + "/" + type + "/" + e.type).success(function(t, i, a, r) {
            e.chip_data = t.chips_data, e.gridOptions.api.setRowData(e.chip_data), s(t.chips_data, ""), e.SumOfCreadit = e.sum(e.chip_data, "Credit"), e.SumOfDebit = e.sum(e.chip_data, "Debit")
        })
	...
	if(h== "1970-01-01" || h==0)
	{
        ...
        t.get(BASE_URL+"Betentrycntr/Chip_leger/" + e.user_id + "/" + e.type + "/" + d + "/" + o + "/" + h).success(function(t, i, a, r) {
            e.loading=false;
