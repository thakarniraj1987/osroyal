<?php defined('BASEPATH') OR exit('No direct script access allowed');
		...
		////End of useworking table
			...
			function mobileGetUserMatchLst($sportId){
				...
				if($sportId==4){
					$selectQuery .= ",'$baseUrl"."uploads/cricket.png' sport_image";	
				}elseif ($sportId==2) {
					$selectQuery .= ",'$baseUrl"."uploads/tennis.png' sport_image";	
				}elseif ($sportId==1) {
					$selectQuery .= ",'$baseUrl"."uploads/soccer.png' sport_image";	
				}
