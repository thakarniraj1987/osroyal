...
<li id="si{{displyData.id}}" class="submenu" ng-repeat="displyData in sprtData | orderBy : 'name'" ng-if="displyData.id != 7">

  <a href="javascript:void(0)" ng-click="$root.selectedRow='';resetCall(displyData.id);ShowHideAng1(displyData.id,0);"> 
