<div style="padding-left:0px;">
 ...
 <input id="tab1" class="tab-inp" type="radio" name="tabs"  ng-model="treeAcc" ng-value="false" ng-checked="!treeAcc"></input>
 	...
 	<li ui-sref-active="active" ng-click="ShowHideAng(0)" class="active treeview"> <a onclick="myfun()"  ui-sref="{{getDashboardurl()}}"> <i class="fa fa-dashboard"></i><span>Market Watch</span> </a> </li>
<li><a onclick="myfun()" ng-show="$root.HelperAllRights==angular.isUndefinedOrNull || $root.HelperAllRights.UpdateUser==1" href="" ui-sref="dashboard.OnePageRprt"><i class="fa fa-file" aria-hidden="true"></i>  One Page Report</a> </li>
<li><a onclick="myfun()" ng-show="$root.HelperAllRights==angular.isUndefinedOrNull || $root.HelperAllRights.UpdateUser==1" href="" ui-sref="dashboard.Matches"><i class="fa fa-file" aria-hidden="true"></i>  Shedule Match</a> </li>
            ...
            <ul class="treeview-menu">
              <li ui-sref-active="treeview active"> <a onclick="myfun()" ui-sref="dashboard.DelChipLst">Settlement Entry List</a> </li>
              <li ui-sref-active="treeview active"> <a onclick="myfun()" ui-sref="dashboard.SeriesActDact">Series Setting</a> </li>
              <li ui-sref-active="treeview active"> <a onclick="myfun()" ui-sref="dashboard.Createfancy">Match Setting</a> </li>
              <li ui-sref-active="treeview active"> <a onclick="myfun()" ui-sref="dashboard.ListOfMarket">Market Setting</a> </li>
              
            <!--  <li ui-sref-active="treeview active"> <a ui-sref="dashboard.Listmarkettype">Market Type</a> </li> -->
              <li ui-sref-active="treeview active" ng-show="$root.HelperAllRights==angular.isUndefinedOrNull || $root.HelperAllRights.Result==1" > <a onclick="myfun()" ui-sref="dashboard.match_result">Set Match Result</a> </li>
           <!--   <li ui-sref-active="active"> <a ui-sref="dashboard.userRightsCntr">User permissions</a> </li> -->
              <li ui-sref-active="treeview active"> <a onclick="myfun()" ui-sref="dashboard.SetAdminLimitCntr">Settings</a> </li>
          <!--    <li ui-sref-active="treeview active"> <a ui-sref="dashboard.CrtSubAdminCntr">Create Sub Admin</a> </li>  -->
              <li ui-sref-active="treeview active"> <a onclick="myfun()" ui-sref="dashboard.closeUserListCntr">Closed Users Account</a> </li>
              <li ui-sref-active="treeview active"> <a onclick="myfun()" ui-sref="dashboard.Delete_old_data">Remove Old Game + Users Data</a> </li>
              <li ui-sref-active="treeview active"> <a onclick="myfun()" ui-sref="dashboard.Delete_old_bet_data">Remove Old Bet Data</a> </li>
            </ul>
          </li>
        
 <li ui-sref-active="active" class="ul main-spr {{getCssVal(displyData.id)}}" ng-repeat="displyData in sprtData">
<a onclick="myfun()" ng-click="ShowHideAng(displyData.id,0)"   ui-sref="dashboard.Getseriesfrmapi({sportId: displyData.id})" ng-if="displyData.id != 7"><img src="app/images/sportsicon/{{displyData.name}}.png">&emsp;
...
<!--<a ng-click="ShowHideAng(displyData.id,0)" ui-sref="dashboard.Getmatchfrmapi({seriesId: match.seriesId,sportId:displyData.id})" ng-if="displyData.id == 7"><img src="app/images/{{displyData.name}}.png">&emsp;
            ...
            <ul  class="treeview-menu" ng-if="accordion==displyData.id && displyData.id != 7">
              <li class="sub-item {{getCssVal(sportsId)}}" ng-repeat="match in GetSeriesData" ng-show="accordionLv2==0 || accordionLv2==match.seriesId"  ng-click="getSeriesMatch(displyData.id,match.seriesId);"> <a onclick="myfun()" href="javascript:void();" ui-sref="dashboard.Getmatchfrmapi({seriesId: match.seriesId,sportId:displyData.id})"> {{match.Name}} </a> 
                <!--Match-->
                      ...
                      <li class="sub-item {{getCssVal(displyData.id)}}" ng-repeat="series in inPlay" ng-if="accordionLv1==0 || accordionLv1==series.MstCode"> <a ng-init="dropdownInplay['field_'+$index]=false" href="" ng-click="getMatchMarket(displyData.id,series.MstCode)"> {{series.matchName}} </a> <span class="myMenu2" ng-click="printParent2($event,series,1,$index);" ng-show="displyData.id==4"> </span> 
                        ...
                        <ul class="accordion-content " ng-show="accordionLv1==series.MstCode">
                          <li ng-repeat="market in MatchMarket" class="market_type"  ui-sref-active="active"> <a ng-init="market.IsPlayIcon==1?chkMarketPP=false:chkMarketPP=true;" href=""> </a> 
                            ...
                            <a onclick="myfun()" ng-if="displyData.id==4"  href="" class="match-od-link" ui-sref="dashboard.Matchodds({MatchId: series.MstCode,MarketId:market.Id,matchName:series.matchName,date:series.MstDate,sportId:series.SportID})" > {{market.Name}} </a> <a onclick="myfun()" ng-if="displyData.id!=4"  href="" class="match-od-link" ui-sref="dashboard.Matchodds({MatchId: series.MstCode,MarketId:market.Id,matchName:series.matchName,date:series.MstDate,sportId:series.SportID})" > {{market.Name}} </a> </li>
   ...
   <ul class="treeview newtree" ng-show="InplayClick==$index && dropdownInplay['field_'+$index]">
              ...
              <li>
                <a onclick="myfun()" ui-sref="dashboard.CntrAdminSesssionFancy({matchId: CreateFancyMatchInfo.MstCode,sportId:CreateFancyMatchInfo.SportID})">Session Fancy</a>
              </li>
<li>
                <a onclick="myfun()" ui-sref="dashboard.CntrAdminIndianFancy({matchId: CreateFancyMatchInfo.MstCode,sportId:CreateFancyMatchInfo.SportID})">Indian Fancy</a>
              </li>
<li>
                <a onclick="myfun()" ui-sref="dashboard.CntrBetfairFancy({matchId: CreateFancyMatchInfo.MstCode,sportId:CreateFancyMatchInfo.SportID})">Betfair Market</a>
              </li>
              <li ng-if="false">
                    ...
                    <ul class="accordion-content" ng-show="accordionLv2==match.seriesId">
                      <li class="sub-item {{getCssVal(displyData.id)}}" ng-repeat="series in upComing" ng-show="accordionLv1==0 || accordionLv1==series.MstCode"> <a ng-init="dropdownInplay['field_'+$index+'u']=false" href="" ng-click="getMatchMarket(displyData.id,series.MstCode)"> {{series.matchName}} </a> <span class="myMenu2" ng-click="printParent2($event,series,2,$index+'u');" ng-show="displyData.id==4"> </span> 
                        ...
                        <ul class="accordion-content " ng-show="accordionLv1==series.MstCode">
                          <li ng-repeat="market in MatchMarket" class="market_type"  ui-sref-active="active"> <a ng-init="market.IsPlayIcon==1?chkMarketPP=false:chkMarketPP=true;" href=""  > </a> 
                            <!--   css add by aasha mam and sp create by ajay sir then uncomment this code pls concern to sourabh sir --> 
                            <a onclick="myfun()"  href="" class="match-od-link" ui-sref="dashboard.Matchodds({MatchId: series.MstCode,MarketId:market.Id,matchName:series.matchName,date:series.MstDate,sportId:series.SportID})" > {{market.Name}} </a> </li>
                          <li class="market_type" ng-repeat="fancyArr in getMatchFancy"> 
                            <!-- Start Fancy Type 123-->
                            <div ng-if="fancyArr.TypeID==1" ui-sref-active="active"> <a ng-init="fancyArr.IsPlayIcon==1?chkMarketPPF=false:chkMarketPPF=true;" href="" > </a> <a onclick="myfun()" class="match-od-link" ui-sref="dashboard.Evenoddfancy({matchId: series.MstCode,FancyID:fancyArr.ID,TypeID:fancyArr.TypeID,matchName:series.matchName,sportId: displyData.id})">{{fancyArr.HeadName}}</a> </div>
                            <div ng-if="fancyArr.TypeID==2" ui-sref-active="active"> <a ng-init="fancyArr.IsPlayIcon==1?chkMarketPPF=false:chkMarketPPF=true;" href="" > </a> <a onclick="myfun()" class="match-od-link" ui-sref="dashboard.Sessionfancy({matchId: series.MstCode,FancyID:fancyArr.ID,TypeID:fancyArr.TypeID,matchName:series.matchName,sportId: displyData.id})">{{fancyArr.HeadName}}</a>
                              <button type="button" ng-click=displayScorePosition(fancyArr.ID,fancyArr.TypeID,series.MstCode)>SC2</button>
                            </div>
                            <div ng-if="fancyArr.TypeID==3" ui-sref-active="active"> <a ng-init="fancyArr.IsPlayIcon==1?chkMarketPPF=false:chkMarketPPF=true;" href="" > </a> <a onclick="myfun()" class="match-od-link" ui-sref="dashboard.Khaddalfancy({matchId: series.MstCode,FancyID:fancyArr.ID,TypeID:fancyArr.TypeID,matchName:series.matchName})">{{fancyArr.HeadName}}</a> </div>
                            <div ng-if="fancyArr.TypeID==4" ui-sref-active="active"> <a ng-init="fancyArr.IsPlayIcon==1?chkMarketPPF=false:chkMarketPPF=true;" href="" > </a> <a class="match-od-link" ui-sref="dashboard.Lastdigit({matchId: series.MstCode,FancyID:fancyArr.ID,TypeID:fancyArr.TypeID,matchName:series.matchName})">{{fancyArr.HeadName}}</a> </div>
                            <div ng-if="fancyArr.TypeID==5" ui-sref-active="active"> <a ng-init="fancyArr.IsPlayIcon==1?chkMarketPPF=false:chkMarketPPF=true;" href="" > </a> <a class="match-od-link" ui-sref="dashboard.Updown({matchId: series.MstCode,FancyID:fancyArr.ID,TypeID:fancyArr.TypeID,matchName:series.matchName})">{{fancyArr.HeadName}}</a> </div>
                          </li>
                        </ul>
      ...
      <section id="content2" class="tab-content clearfix" ng-show="treeAcc==1">
        <div class="col-sm-12 col-md-12">
          ...
          <ul>
            ...
            <li ng-hide="node.usetype == 0"> <a ng-show="$root.HelperAllRights==angular.isUndefinedOrNull || $root.HelperAllRights.UpdateUser==1" href="" ng-click="showViewSetting(node,currentScope1);">View Acc.</a> </li>
