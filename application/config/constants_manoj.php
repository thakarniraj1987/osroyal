...
define('BR_SERIES_SPORTS_URL','http://109.74.202.195/api/v1/betting_api/get_series_by_sport.php?sport_id=');
define('BR_SUPER_AMDIN_URL','http://109.74.202.195/api/v1/betting_api/get_match_by_series.php?series_id=');
define('BR_SUPER_AMDIN_ALLMATCHES_URL','http://109.74.202.195/api/v1/betting_api/getAllMatches.php');  // Get All matches
define('BR_SUPER_AMDIN_FANCY_URL','http://109.74.202.195/api/v1/savesession_sessionslist.php?market_id=');
define('BR_LIVE_SESSION_URL','http://109.74.202.195/api/v1/get_match_betfair_session.php?market_id=');
define('BR_LIVE_ODDS_URL','http://109.74.202.195/api/v1/get_odds_by_market_ids.php?');
define('BR_LIVE_SERIES_URL','http://109.74.202.195/api/v1/betting_api/get_match_by_series.php?series_id=');
...
define('EXCH_BACK_LAY_BY_MARKETS_URL','http://109.74.202.195/api/v1/get_back_lay_price.php'); // check odd on markete bets

define('EXCH_ODDS_BY_MARKETS_URL','http://109.74.202.195/api/v1/get_odds_by_market_ids.php');


define('BETFAIR_SESSION_URL','http://sa.betdip.com/BetfairApicontroller/get_betfair_session/'); // not used

define('BETFAIR_SELECTION_URL','http://109.74.202.195/api/v1/betting_api/match_selection.php?market_id=');  // Get Match Selection
