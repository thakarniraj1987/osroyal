...
<a class="navbar-brand js-scroll-trigger" ui-sref="masterDashboard.Home"><img src="{{$root.logo}}" alt="Logo"></a>
...
<li ng-if="false"  ui-sref-active="active" onclick="mobilefun()"><a ui-sref="masterDashboard.CollectionReport"><i style="float: left;position: relative;" class="fa fa-file" aria-hidden="true"></i>  Collection Report</a> </li>
