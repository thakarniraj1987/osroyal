...
<li><a ng-show="$root.HelperAllRights==angular.isUndefinedOrNull || $root.HelperAllRights.UpdateUser==1" href="" ui-sref="dashboard.OnePageRprt"><i class="fa fa-file" aria-hidden="true"></i>  One Page Report</a> </li>
<li><a ng-show="$root.HelperAllRights==angular.isUndefinedOrNull || $root.HelperAllRights.UpdateUser==1" href="" ui-sref="dashboard.Matches"><i class="fa fa-file" aria-hidden="true"></i>  Shedule Match</a> </li>
          ...
          <!--    <li ui-sref-active="treeview active"> <a ui-sref="dashboard.CrtSubAdminCntr">Create Sub Admin</a> </li>  -->
              ...
              <li ui-sref-active="treeview active"> <a ui-sref="dashboard.Delete_old_data">Remove Old Game + Users Data</a> </li>
              <li ui-sref-active="treeview active"> <a ui-sref="dashboard.Delete_old_bet_data">Remove Old Bet Data</a> </li>
            </ul>
          </li>
        
 <li ui-sref-active="active" class="ul main-spr {{getCssVal(displyData.id)}}" ng-repeat="displyData in sprtData">
<a ng-click="ShowHideAng(displyData.id,0);cancelSeriesTimeout();"   ui-sref="dashboard.Getseriesfrmapi({sportId: displyData.id})" ng-if="displyData.id != 7"><img src="app/images/sportsicon/{{displyData.name}}.png">&emsp;
...
<!--<a ng-click="ShowHideAng(displyData.id,0)" ui-sref="dashboard.Getmatchfrmapi({seriesId: match.seriesId,sportId:displyData.id})" ng-if="displyData.id == 7"><img src="app/images/{{displyData.name}}.png">&emsp;
            ...
            <ul  class="treeview-menu" ng-if="accordion==displyData.id && displyData.id != 7">
              <li class="sub-item {{getCssVal(sportsId)}}" ng-repeat="match in GetSeriesData" ng-show="accordionLv2==0 || accordionLv2==match.seriesId"  ng-click="getSeriesMatch(displyData.id,match.seriesId);"> <a href="javascript:void();" ui-sref="dashboard.Getmatchfrmapi({seriesId: match.seriesId,sportId:displyData.id})"> {{match.Name}} </a> 
                <!--Match-->
                <ul class="treeview-menu" ng-show="accordionLv2==match.seriesId">
                  <li> <a href="javascript:void();">Inplay</a>
                    <ul class="accordion-content" ng-if="accordionLv2==match.seriesId">
                      <li class="sub-item {{getCssVal(displyData.id)}}" ng-repeat="series in inPlay" ng-if="accordionLv1==0 || accordionLv1==series.MstCode"> <a href="" ng-click="getMatchMarket(displyData.id,series.MstCode)"> {{series.matchName}} </a> <span class="myMenu2" ng-click="printParent2($event,series);" ng-show="displyData.id==4"> </span> 
                        <!--Fancy & market-->
            ...
            <ul class="treeview newtree" ng-show="dropdown124">
              <li ng-if="false">
                ...
                <a ng-click="showCreateFancy($event,5)">Up Down Fancy</a>
                  ...
                  <li> <a href="javascript:void();">Upcoming</a>
                    <ul class="accordion-content" ng-show="accordionLv2==match.seriesId">
                      <li class="sub-item {{getCssVal(displyData.id)}}" ng-repeat="series in upComing" ng-show="accordionLv1==0 || accordionLv1==series.MstCode"> <a href="" ng-click="getMatchMarket(displyData.id,series.MstCode)"> {{series.matchName}} </a> <span class="myMenu2" ng-click="printParent2($event,series);" ng-show="displyData.id==4"> </span> 
                        <!--Fancy & market-->
                        <ul class="accordion-content " ng-show="accordionLv1==series.MstCode">
                          <li ng-repeat="market in MatchMarket" class="market_type"  ui-sref-active="active"> <a ng-init="market.IsPlayIcon==1?chkMarketPP=false:chkMarketPP=true;" href=""  > </a> 
                            <!--   css add by aasha mam and sp create by ajay sir then uncomment this code pls concern to sourabh sir --> 
