...
<div class="load-box ng-hide" ng-show="loading">
 ...
 <i id="closedthis" onclick="removefullscreen()" ng-click="$root.betslipshow=false;" class="fa fa-times"></i> 
 ...
 <label ng-if="back.isback==1" class="before_lay">Lay</label>
  ...
  <li>
    <div class="form-group">
      ...
      <input type="number" ng-change="updateLiability(back)" ng-pattern="/^[0-9]+(\.[0-9]{1,2})?$/" min="0" step="0.01" ng-model="back.priceVal" class="form-control" ng-disabled="back.is_session_fancy!='N'">
    </div>
  </li>
  <li>
...
<div class="showallbets"> <input checked="checked" name="checkbox-group" ng-model="IsShowBetInfo" id="test1" type="checkbox">
  ...
  <div class="show_betinfo" >
     ...
     <!--   <div class="livetv_heading collapsed" data-toggle="collapse" data-target="#livetv" aria-expanded="true">Live TV</div>-->
        ...
        <div class="livetv collapse" id="livetv">      
           ...
           <div class="livevideo"> 
         <video width="560" height="349" autoplay="" controls="" src="http://109.237.26.156:8021/">
