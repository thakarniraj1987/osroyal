          ...
          <table class="table table-striped my-market">
            ...
            <tbody>
             <tr ng-repeat="mtchRs in matchResult">
                <td data-label="Match Name"><a href="" ui-sref="dealerDashboard.Matchodds({MatchId: mtchRs.matchId,MarketId:mtchRs.marketId,matchName:mtchRs.matchName,date:mtchRs.date,sportId:mtchRs.SportID})">{{mtchRs.matchName}}</a></td>
