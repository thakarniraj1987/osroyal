	...
	class TestoddsCtrl extends CI_Controller {
		...
		function getTokenId(){
			...
			if ($_POST['TokenId']!=null) {
				...
				$TokenId = "yPAFq7YCIi/nVwwwGe1vr2IM/v+LtGxRvEhmHyzTbx8=";
		...
		function getBackLaysOfMarket($MarketId=null,$MatchId=null){//170201
			...
			$data['MarketRunner'] = $this->getMarketBook($this->APP_KEY, $sessionToken, '1.135212851');//170131
...

		{
			...
			//if($userId==null)$userId1=0;else $userId1=$userId;
				...
				//$data['MarketRunner']=$this->getMarketBook($this->APP_KEY, "GOyxr1E*f]<xxUx", $MarketId1);//sourabh 170130

				$data['runnerSlName']=$this->getNextUkHorseRacingMarket2($this->APP_KEY, "GOyxr1E*f]<xxUx", $MarketId1);//sourabh 170130
